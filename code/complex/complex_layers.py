...
from torch.nn import Conv1d, Conv2d, Conv3d, Linear, BatchNorm1d, BatchNorm2d, BatchNorm3d, LayerNorm
from torch.nn import ConvTranspose2d
from .complex_functions import complex_relu, complex_prelu, complex_max_pool2d, complex_avg_pool2d, complex_max_pool3d
...
class ComplexPReLU(Module):
    ...
    def forward(self, input):
        return complex_prelu(input, weight=self.weight)
